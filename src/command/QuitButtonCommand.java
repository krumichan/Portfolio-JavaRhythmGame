...
public class QuitButtonCommand extends ButtonCommand {

	@Override
	public void entered(MouseEvent e) {
		button.setIcon(ImageManager.imageManager().getImageIcon(IMAGE_ID.QUIT_BUTTON_ENTERED));
	...
	public void exited(MouseEvent e) {
		button.setIcon(ImageManager.imageManager().getImageIcon(IMAGE_ID.QUIT_BUTTON_BASIC));
